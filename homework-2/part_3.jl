...
v = copy(u)
saved_solutions = solve(ForwardEuler(), v, rhs!, (0, 10), 1/1024, [5], num_saved_steps=100)
...
v = copy(u)
saved_solutions = solve(ExplicitMidpoint(v), v, rhs!, (0, 10), 1/1024, [5], num_saved_steps=100)
